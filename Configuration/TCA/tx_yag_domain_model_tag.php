...
return array(
	'ctrl' => array(
		...
		'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('yag') . 'Resources/Public/Icons/tx_yag_domain_model_tag.png'
	),
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_yag_domain_model_tag.pid=###CURRENT_PID### AND tx_yag_domain_model_tag.sys_language_uid IN (-1,0)',
			),
		),
