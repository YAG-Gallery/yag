...
class Tx_Yag_Extlist_Filter_RandomUidFilter extends Tx_PtExtlist_Domain_Model_Filter_AbstractFilter {
	...
	protected function getRandomUIDs() {
		$itemRepository = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('Tx_Extbase_Object_ObjectManager')->get('Tx_Yag_Domain_Repository_ItemRepository'); /** @var $itemRepository Tx_Yag_Domain_Repository_ItemRepository */
