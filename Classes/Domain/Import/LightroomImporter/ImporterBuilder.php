...
class Tx_Yag_Domain_Import_LightroomImporter_ImporterBuilder extends Tx_Yag_Domain_Import_ImporterBuilder {
    ...
    /**
     * Returns an instance of lightroom impoter for a given album
     *
     * @param Tx_Yag_Domain_Model_Album $album
     * @return Tx_Yag_Domain_Import_LightroomImporter_Importer Instance of lightroom importer
     */
    public function getLightroomImporterInstanceForAlbum(Tx_Yag_Domain_Model_Album $album) {
    	$lightroomImporter = $this->createImporterForAlbum('Tx_Yag_Domain_Import_LightroomImporter_Importer', $album); /* @var $lightroomImporter Tx_Yag_Domain_Import_LightroomImporter_Importer */
    	return $lightroomImporter;
    }
