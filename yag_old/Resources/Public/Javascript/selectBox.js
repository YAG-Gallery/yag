...
// -------------------------------------------------------------------
// copyOptionsToTextbox(selectbox_id,textbox_id)
//  writes all values of select box options to a textfield
// -------------------------------------------------------------------
function copyOptionsToTextbox(selectboxId, textboxId) {
    var selectBoxOptions = document.getElementById(selectboxId).options;
    var textbox = document.getElementById(textboxId);
    textbox.value = '';
    for (var i = 0; i < selectBoxOptions.length; i++) {
        textbox.value += selectBoxOptions[i].value ;
        if (i < selectBoxOptions.length - 1) {
            textbox.value += ',';
        }
    }
}